...
This defines the schedular.   With this alone it'll still schedule everything on the same node.  adding the below to each metadata.template.spec you force it to schedule on separate nodes.  I wanted this as I didnt want any part of dispatcharr to affect another part.  I.E. Celery eating cpu which can affect streams.  You can remove this specs if you want.  Entirely up to you.
